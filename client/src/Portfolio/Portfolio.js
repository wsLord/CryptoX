            ...
            <div className="d-flex justify-content-around" id={Styles.top}>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body d-flex justify-content-around">
                            ...
                            <div className="d-flex flex-column">
                                ...
                                <button type="button" onClick={onClickWithdraw} className="btn btn-outline-dark m-2">
                                    <img className={Styles.icon} src={withdrawimg} alt="" />
                                    <span className={Styles.text}> Withdraw</span>
                                </button>
                                <button type="button" onClick={onClickTransaction} className="btn btn-outline-dark m-2">
                ...
                <div className="w-100">
                    ...
                    <div className="card w-100">
                        <div className="card-header "><h3>Daily Report</h3></div>
