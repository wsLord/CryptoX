...
// 								<p className="text-primary h5">{transaction.coinName} purchased of value</p>
// 							)}
// 							{transaction.category === "sell" && (
// 								<p className="text-primary h5">{transaction.coinName} sold of value</p>
// 							)}
// 							<p className="h3">
// 								{transaction.quantity} ({transaction.coinSymbol})
// 							</p>
// 							<p className="mx-auto h5" id={Styles.tid}>
// 								Transaction ID: <span className="text-secondary">{transaction.id}</span>
// 							</p>
...
// 									</p>
// 									<p className="h5">Price at that time (per {transaction.coinSymbol})</p>
// 									<p className="fs-6 text-secondary">&#8377; {transaction.price}</p>
// 								</div>
// 							</div>
// 							<Link className="btn btn-success mt-2 fs-5" to="/orders">
// 								Back to orders list
// 							</Link>
// 						</div>
// 					)}
...
// 							{transaction.category === "buy" && (
// 								<p className="text-primary h5">Buy {transaction.coinName} of value</p>
// 							)}
// 							{transaction.category === "sell" && (
// 								<p className="text-primary h5">Sell {transaction.coinName} of value</p>
// 							)}
// 							<p className="h3">
// 								{transaction.quantity} ({transaction.coinSymbol})
// 							</p>
...
// 									<p className="fs-6 text-secondary">{transaction.statusMessage}</p>
// 								</div>
// 							</div>
// 							<Link className="btn btn-danger mt-2 fs-5" to="/orders">
// 								Back to orders list
// 							</Link>
// 						</div>
// 					)}
